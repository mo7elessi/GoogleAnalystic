...
class food : Fragment(), productAdapter.onClick {
    ...
    override fun onCreateView(
        ...
        googleAnalytics.trackScreen("food")
    ...
    override fun onDestroy() {
        ...
        total = end - start
        googleAnalytics.time(total, "002", "food")
        super.onDestroy()
    }

    fun getAllProducts() {
        db!!.collection("food").get().addOnSuccessListener { querySnapshot ->
